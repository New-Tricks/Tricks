...
- **Discover** — one search across skill repositories, Claude/APM marketplaces, skills.sh and GitHub, with trust, licence and risk facets. Identical copies are grouped.
...
- **Customize** — vendor an upstream skill into your workspace, edit it, and keep merging upstream improvements in VS Code's three-way merge editor.
